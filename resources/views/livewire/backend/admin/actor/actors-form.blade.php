      ...
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        ...
        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
          <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
            {{ $action === 'create' ? 'Agregar Actor' : 'Modificar Actor' }}
          </h3>
          <button type="button"
          ...
          <div class="grid gap-4 mb-4 grid-cols-1">
            ...
            <div class="col">
              ...
              <input type="text" id="first_name"
                     class="@error('first_name') focus:ring-red-500 focus:border-red-500 dark:border-red-500 @enderror bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
