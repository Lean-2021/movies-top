    ...
    <div class="grid lg:grid-cols-2 gap-5 mt-20">
        <div class="p-6 rounded-lg drop-shadow-[0px_8px_4px_rgba(0,0,0,0.5)] hover:bg-indigo-800 dark:bg-indigo-700">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="size-6 stroke-2 stroke-slate-300">
            ...
            <a href="{{ route('movies') }}" class="inline-flex font-medium items-center text-slate-100 hover:underline">
                Ver detalles
