...
<div>
  ...
  <div class="grid lg:grid-cols-2 gap-5 mt-20">
    <div
      class="p-6 rounded-lg drop-shadow-[0px_8px_4px_rgba(0,0,0,0.5)] hover:bg-indigo-800 dark:bg-indigo-700">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
           class="size-6 stroke-2 stroke-slate-300">
    ...
    {{--  Géneros --}}
    <div
      class="p-6 rounded-lg drop-shadow-[0px_8px_4px_rgba(0,0,0,0.5)] hover:bg-teal-800 dark:bg-teal-700">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
           class="size-6 stroke-2 stroke-slate-300">
        <path stroke-linecap="round" stroke-linejoin="round"
      ...
      {{--    <p class="mb-3 font-normal text-gray-500 dark:text-slate-200">Panel de administración de películas</p>--}}
      <a href="{{route('genres')}}" class="inline-flex font-medium items-center text-slate-100 hover:underline">
        Ver detalles
        <svg class="w-3 h-3 ms-2.5 rtl:rotate-[270deg]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
             fill="none" viewBox="0 0 18 18">
          <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    {{--  Directores --}}
    <div
      class="p-6 rounded-lg drop-shadow-[0px_8px_4px_rgba(0,0,0,0.5)] hover:bg-violet-800 dark:bg-violet-700">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
           class="size-6 stroke-2 stroke-slate-300">
        <path stroke-linecap="round" stroke-linejoin="round"
    ...
    {{--  Estudios --}}
    <div
      class="p-6 rounded-lg drop-shadow-[0px_8px_4px_rgba(0,0,0,0.5)] hover:bg-sky-800 dark:bg-sky-700">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
           class="size-6 stroke-2 stroke-slate-300">
        <path stroke-linecap="round" stroke-linejoin="round"
    ...
    {{--  Actores --}}
    <div
      class="p-6 rounded-lg drop-shadow-[0px_8px_4px_rgba(0,0,0,0.5)] hover:bg-orange-800 dark:bg-orange-700">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
           class="size-6 stroke-2 stroke-slate-300">
        <path stroke-linecap="round" stroke-linejoin="round"
