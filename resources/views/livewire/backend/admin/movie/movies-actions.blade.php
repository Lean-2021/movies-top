<div class="flex justify-between items-center">
  <button title="Vista Previa" data-modal-toggle="movies{{$row}}-card" data-modal-target="movies{{$row}}-card"
          class=""><i
  ...
  {{--  @include('livewire.backend.admin.movies.directors-modal-preview')--}}
</div>
