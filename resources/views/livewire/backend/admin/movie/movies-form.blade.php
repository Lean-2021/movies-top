        ...
        <div class="relative max-w-xl max-h-full p-4 m-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <form class="p-4 md:p-5">
                    <div class="grid grid-cols-1 gap-4 mb-4">
                        ...
                        <div class="grid grid-cols-2 mb-2 gap-x-3">
                            ...
                            <div class="col">
                                ...
                                <!-- Dropdown menu -->
                                <div id="genres"
                                    class="@error('genres') focus:ring-red-500 focus:border-red-500 dark:border-red-500 @enderror z-10 hidden divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-900 dark:divide-gray-500 border-2 border-blue-600 w-64">
                    ...
                    <div class="grid grid-cols-3 mb-5 gap-x-3">
                        {{-- Duración --}}
                        <div class="col">
                            <label for="duration"
                    ...
                    <div class="grid grid-cols-2 mb-5 gap-x-3">
                        {{--  actores  --}}
                        <div class="col">
                            <label for="actors"
                            ...
                            <!-- Dropdown menu -->
                            <div id="actors"
                                class="@error('actors') focus:ring-red-500 focus:border-red-500 dark:border-red-500 @enderror z-10 hidden divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-900 dark:divide-gray-500 border-2 border-blue-600 w-64">
                                <ul class="py-2 overflow-scroll text-sm text-gray-700 dark:text-gray-200 max-h-72"
                        ...
                        <div class="col">
                            ...
                            <!-- Dropdown menu -->
                            <div id="directors"
                                class="@error('directors') focus:ring-red-500 focus:border-red-500 dark:border-red-500 @enderror z-10 hidden divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-900 dark:divide-gray-500 border-2 border-blue-600 w-64">
                                <ul class="py-2 overflow-scroll text-sm text-gray-700 dark:text-gray-200 max-h-72"
